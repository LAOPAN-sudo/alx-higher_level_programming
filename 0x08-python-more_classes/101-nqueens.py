...
Determines all possible solutions for chessboard.
...
Solutions are rep and column, respectively, on the chessboard.
"""
import sys
...
def get_solution(board):
    ...
    Returns:
        list: A list of queen in the format [[r, c], [r, c], [r, c], [r, c]].
    """
    solution = []
